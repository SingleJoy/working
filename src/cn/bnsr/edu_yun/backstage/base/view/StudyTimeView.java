...
public class StudyTimeView extends PageBase{
	...
	private String group;//1,按时 2,按天
	...
	public String getStudyTimeViews() {
		return studyTimeViews;
	}
	public void setStudyTimeViews(String studyTimeViews) {
		this.studyTimeViews = studyTimeViews;
	}
