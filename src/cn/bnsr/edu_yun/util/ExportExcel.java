...
//2
	public void exportExcel(String title,String[] headers,String[] fieldNames, Collection<T> dataset,
			OutputStream out) {
		exportExcel(title, headers,fieldNames,  dataset, out, "yyyy-MM-dd");
	}
//1
	public void exportExcel(String[] headers,String[] fieldNames, Collection<T> dataset,
			OutputStream out, String pattern) {
		exportExcel("测试POI导出EXCEL文档", headers,fieldNames,  dataset, out, pattern);
	}

	// 判断是什么浏览器
	public String getExplorer(HttpServletRequest request){
	...
	public String getFileName(String FileName, String explorer) throws UnsupportedEncodingException {
		...
		while (it.hasNext()) {
			...
			for (short i = 0; i < fieldNames.length; i++) {
				...
				String getMethodName = "get"
						+ fieldNames[i].substring(0, 1).toUpperCase()
