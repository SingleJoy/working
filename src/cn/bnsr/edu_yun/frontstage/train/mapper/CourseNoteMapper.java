...
public interface CourseNoteMapper {
	...
	int queryTotalCourseIdsNote(TrainDetailView trainDetailView);
	  ...
	  List<cn.bnsr.edu_yun.frontstage.train.view.CourseNoteView> queryNoteM(@Param("user_id")long user_id,@Param("course_id")long course_id,@Param("status")int status);
}