...
<script type="text/javascript" charset="utf-8">
	...
	$(function() {
		...
		ctrlTree = $('#ctrlTree').tree({
			url : '${pageContext.request.contextPath}/back_menu/doNotNeedSession_tree.action',
			lines : true,
...
<%-- 	<div title="其他示例" data-options="isonCls:'icon-save',href:'${pageContext.request.contextPath}/admin/easyuiadmin/easyuiadmin.jsp'"></div> --%>
</div>