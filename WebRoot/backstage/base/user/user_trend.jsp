	...
	<div class="main_body">
		...
		<div class="time user_info">
			<div>
				...
				<span  title="新增注册用户数">新增用户</span><br/>
			...
			<div>
				...
				<span title="用户平均在线时长">平均浏览时间</span><br/>

				<label class="number" id="collectmeanVisit"></label>
			</div>
			<div >

				<span title="新用户平均在线时长">新用户平均浏览时间</span> <br/>
		...
		<div class="time" style="clear: both;margin-top: 50px;">
			<table class="table_sta">
				...
				<tr>
					<th>日期</th>
					<th title="新注册用户数">新增数</th>
					<th title="登陆用户数">登录数</th>
					<th  title="用户平均在线时长"> 平均访问时长</th>
					<th title="用户平均在线时长"> 新用户平均访问时长</th>
				</tr>
        ...
        $.ajax({
            ...
            success : function(d) {
                ...
                for(var i=0;i<list.length;i++){
                    ...
                    addUserNum += list[i].newNum;
                    loginUserNum += list[i].loginNum;
                    if("${timeUnit}"==0){
                ...
                tbody += '<tr><td>汇总</td><td>'+addUserNum+'</td><td>'+loginUserNum+'</td><td>'+d.collectmeanVisit+'</td><td>'+d.collectmeanNewVisit+'</td></tr>';
                $("#addUserNum").html(addUserNum);
                $("#loginUserNum").html(loginUserNum);
