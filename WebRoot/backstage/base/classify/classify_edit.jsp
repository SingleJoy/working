	   ...
	   <input name="id" type="hidden" />
		<table class="tableForm">
			...
			<tr>
				...
				<td><input name="code" style="width:140px;" class="easyui-validatebox" data-options="required:true,missingMessage:'请填写编码'" />
				</td>
			</tr>
			<tr><td>&nbsp;</td></tr>
			<tr>
				<th style="width: 55px;">序号:</th>
				<td><input name="seq" class="easyui-numberspinner" data-options="min:0,max:999,editable:false,required:true,missingMessage:'请选择分类排序'" value="10" style="width:140px;" />
				</td>
			</tr>
			<tr><td>&nbsp;</td></tr>
			<tr>
			...
			<tr>
				...
				<td><input name="parent_id" style="width:140px;"/>
				</td>
			</tr>
		</table>
	</form>
