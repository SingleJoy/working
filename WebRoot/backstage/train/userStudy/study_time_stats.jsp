...
<body class="easyui-layout" data-options="fit:true">
	<div style="font:13.3333px Arial;z-index:9999; margin-left:15px;margin-top: 50px;">
	    <select  onchange="changeUnit(this.value);" style="height: 21px;" >
		...
		&nbsp;
		<select id="timeUnit" name="timeUnit" style="height: 21px;">
		...
		&nbsp;
		<div id="everyday" style="float:left;<c:if test="${timeType==4}">display:none;</c:if>">
   ...
   <div id="studyTimestats" style="width: 780px;height:470px;padding-top: 50px;"></div>
