...
<div id="content-container" class="container">
    ...
    <ol class="breadcrumb breadcrumb-o">
        <li><a href="#" >首页</a></li>
        <li><a href="#">资源</a></li>
        <li><a href="#">${stage}${subject }/${pubver}</a></li>
            ...
            <div class="panel panel-default" >
                    ...
                    <div class="media media-dynamic pull-left" style="display: inline-block;">
                        ...
                        <div class="media-body">
                            <div class="title" style="margin-top: 15px;">
                                <a class="link-dark " href="javascript:void(0);">${file_base.user.username }</a>
                                <span class="mlm mrm text-muted">｜</span>
                                <span class="glyphicon glyphicon-eye-open"></span>
                                <span class="text-warning">${file_base.file_property.click_times }</span>
                                次浏览<span class="mlm mrm text-muted">｜</span>
                ...
                <div class="panel-body" >
                    ...
                    <form class="form-horizontal clearfix"  method="post" >
                        ...
                        <!--资源展示区域-->
                        <c:if test="${format!='mp4'&&format!='mp3' }">
                        <iframe src="${dcsUrl }"
                                frameborder=0 width=100% height=800 style="margin-top: 20px;" allowfullscreen></iframe>
                                </c:if>
                                 <c:if test="${format=='mp4'||format=='mp3' }">
                                <video id="example_video_1" class="video-js vjs-default-skin vjs-big-play-centered" controls preload="none" style="width: 100%;height: 100%;"
		                            ...
		                            <source id="video_source" src="${dcsUrl }" type='video/mp4' />
		
		                        </video>
		                        </c:if>
                        <div style="border: 1px solid #ddd;margin-top: -6px;"></div>
