...
<div class="cn-wrap">
    ...
    <section class="cn-posterswiper-container">
        ...
        <div style="background-color:#0ac895;">

            <div class="container" >

                <%--<ul class="nav navbar-nav pull-right lesson_home_banner">--%>
                    <%--<li class=""><a href="/edu_yun">首页</a></li>--%>
                    <%--<li class="${pageContext.request.contextPath}/lesson_main/to_lesson_main.action"><a href="javascript:void(0);">课例</a></li>--%>
                    <%--<li class=""><a href="javascript:void(0);">学校</a></li>--%>
                    <%--<li class=""><a href="javascript:void(0);">教师</a></li>--%>
        ...
        <div class="container" >
            ...
            <div class="text-line">
                <h5>
                    ...
                    <span>精品推荐&nbsp;&nbsp;
                        <span class="glyphicon glyphicon-map-marker"></span>${area.area_name }
                        <a href="#change_area" data-toggle="modal" style="font-size: 14px;padding-left: 30px;">切换地区</a></span>
                    <div class="line"></div>
                </h5>
                ...
                <c:forEach items="${lessonViews}" var="l">
                    <div class="media">
                        ...
                        <div class="media-body" style="margin-left: 20px;">
                            <h3 class="media-heading">${l.name}</h3>
    ...
    <section class="lesson-list-section">
        <div class="container">
            ...
            <!--全部优秀展示-->
            <div class="course-list clearfix" id="subject_each">
                        ...
                        <div class="course-item">
                            ...
                            <div class="course-info" style="left:0;padding: 5px 10px;">
                                ...
                                <a class="link-dark" href="${pageContext.request.contextPath}/lesson_main/to_lesson.action?id=${l.id }" target="_blank" style="padding: 10px;line-height:30px;">
                                    ...
                                    <div title="工作坊${l.workshop_name }">${l.workshop_name }</div>
                                </a>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-xs-6">
                                        <div class="lesson_item">
                                            <div class="lesson_img" >
                                                <a href="${pageContext.request.contextPath}/community/to_community_index.action?sourceType=0&stamp=5&id=${h.id }" target="_blank" >
    ...
    <section class="teacher-section">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-xs-6 attent" >
                    <div class="teacher-item">
                        <div class="teacher-top">
                            <a class="teacher-img" href="#">
                                <img class="avatar-lg" src="http://scc1a8b2s6-static.qiqiuyun.net/files/default/2016/04-05/1038582980d2485608.jpg" >
                            </a>
                            <div class="title">
    ...
    $("#subject_ul>li").click(function () {
        ...
        function callback(data) {
            ...
            for(var i=0;i<lessonViews.length;i++){
                ...
                html+='<span class="lesson_teacher pull-right">主讲教师:&nbsp;'+lessonViews[i].user_sk_name+'</span>';
