				...
				<div class="panel  panel-col">
					...
					<div  class="panel-body">
							...
							<div class="my-group material-search-list material-tabs" >
								...
								<ul class="js-material-tabs right-content  clearfix" id="js-material-tabs">
									...
									<ul class="js-material-tabs right-content  clearfix" id="js-material-tabs-unit">
							...
							<span class="all">指标：</span>
								<ul class="js-material-tabs right-content  clearfix" id="js-material-tabs-log">
									<li class="active js-type-btn" >
										<a href="javascript:;" onclick="queryTrendBylogType('0');" >提问数</a>
									</li>

									<li class="js-type-btn" >
										<a href="javascript:;" onclick="queryTrendBylogType('1');" >回复数</a>
									</li>
								</ul>
	...
	<script type="text/javascript">
        ...
        function queryTrendByTimeType(index) {
            ...
            $.ajax({
                type : 'POST',
                async : false,
                url : '${pageContext.request.contextPath}/course_chart/get_chart1.action?class_id=${classView.id}&course_id=${classView.source_id}',
                data:{
                    timeType:timeType,
                    group:group,
                    endTime:endTime,
...
//显示
                $.ajax({
                    type : 'POST',
                    async : false,
                    url : '${pageContext.request.contextPath}/course_chart/get_chart_compare1.action?class_id=${classView.id}&course_id=${classView.source_id}&index='+index,
                    data:{
                        timeType:timeType,
                        group:group
                    },
