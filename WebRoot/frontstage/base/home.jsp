...
<head>
    ...
    <style>
        ...
        .bnsr_tree_trunk_banner{background: url("${pageContext.request.contextPath}/frontstage/images/home_images/P-Indx-Tree-Bgimg.jpg") top center repeat-y;}
        .bnsr_tree_bottom_banner{background: url("${pageContext.request.contextPath}/frontstage/images/home_images/P-Indx-Tree-Bottom.jpg") top center no-repeat;
            width: 100%;height: 120px;padding-top: 80px;position: relative;z-index: 2;}
        .footer-background{background: url("${pageContext.request.contextPath}/frontstage/images/home_images/P-Indx-Bottom-Bgimg.png") repeat-x;
            background-position: 0 -50px;width: 100%;height:80px;z-index: -1;position: relative;margin-top: -74px;}
        ...
        .search-button{width: 120px;height: 42px;z-index: 999;background: url("${pageContext.request.contextPath}/frontstage/images/home_images/P-Indx-SearchButton.jpg") no-repeat;
            position: relative;float: left;margin-left: -2px;border: none;}
        .search-button>i{font-size: 30px;line-height: 30px;color: #fff;}

        @media (min-width: 1200px) {
            .resource_enter{position: relative;margin-top: 50px;margin-left:45%;}
            ...
            .search_input{width: 400px;height:40px;padding-left: 10px;float: left;}
            .footer_info{margin-top: -110px;float: right;}
        }
        ...
        @media (min-width:575px) and  (max-width: 991px)  {
            .resource_enter{position: relative;margin-top: 50px;margin-left:42%;}
            ...
            .search_input{width: 400px;height:40px;padding-left: 10px;float: left;}
            .footer_info{margin-top: -110px;text-align: center;}

        }
         @media (min-width:475px) and (max-width: 574px)  {

            .search_input{width: 300px;height:40px;padding-left: 10px;float: left;}


        }
        @media(max-width: 474px)  {

            .search_input{width: 150px;height:40px;padding-left: 10px;float: left;}


        }
        .home_main_content{height:100%;width: 100%;margin: -24px 0 0 0;}
        .search_content{position: relative;margin-top:-120px;}
        .fill_content{height:100%;width: 100%;margin: 0;}
...
<header class="cn-header navbar navbar-bg" style="background-color: #f1f8f1;height:50px;">
    ...
    <div class="container">
        ...
        <div class="navbar-header" >
            ...
            <a href="${pageContext.request.contextPath }" class="navbar-brand">
                <img src="${pageContext.request.contextPath}/frontstage/images/home_images/bnsr_logo.png" style="height:30px;">
            </a>
        </div>
...
<section  class="home_main_content" >
    ...
    <div class="bnsr_home_banner" >

        <div class="container content_enter clearfix" style="position: relative;height: 100%;">
        ...
        <%--搜索框区域--%>
        <div class="text-center clearfix search_content" >
            ...
            <div class="cloud-search-box container">
                <form class="navbar-form " action="${pageContext.request.contextPath}/search/search.action" method="post"  style="text-align: center;">
                    <div class="form-group text-center">
                        <input type="text" name="str" class="search_input" placeholder="可搜索课程、培训、教研、资源、社区、工作坊" >
...
<!--主内容区域bnsr树干填补区域-->
<section  class="clearfix fill_content">

    <div class="bnsr_tree_trunk_banner " style="width: 100%;">
...
<footer class="bnsr_tree_bottom_banner text-center" >

    <div class="container">
        <div class="footer-logo hidden-xs footer_info " >

            <div class="footer-sns " >
                <a href="http://www.edu12.com" target="_blank">
                ...
                <a class="qrcode-popover top">
                    ...
                    <div class="qrcode-content">
                        <!--官方新浪微博照片-->
                        <img src="${pageContext.request.contextPath}/frontstage/images/andriod/bnsr1.0.5.png" alt="">
                    </div>
                </a>
                <a class="qrcode-popover top">
    ...
    <div class="copyright ">
        <div class="container">
            <a href="http://www.edu12.com" target="_blank" class="link-dark">北京百年树人远程教育有限公司</a>
            ©1998-2017
            <span class="mlm mrm">｜</span>
            <a class="link-dark" href="http://www.edu12.com" target="_blank">服务教育，追求卓越</a>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        var this_height=height-800;
        $(".bnsr_tree_trunk_banner").css("height",this_height+'px')
    })
</script>
</body>
</html>