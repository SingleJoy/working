		                                            ...
		                                            <div class="testpaper-question-footer clearfix">
		                                                <div class="testpaper-question-essay-inputs">
		                                                    ...
		                                                    <div id="essay-textarea${question.id }" style="display:none;">
		                                                        ...
		                                                        <%--
		                                                        <input type="text" id="input_answer${question.id }" data-id="${question.id }" class="form-control testpaper-question-essay-input-short essay-textarea" value="${question.answer}" readonly="readonly"/>
		                                                        --%>
		                                                        <%-- face --%>
