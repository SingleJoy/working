...
<div class="cn-wrap">
    ...
    <div id="content-container" class="container">
        ...
        <div class="question-set homework-set">
            ...
            <div class="row question-set-heading" style="margin-top:20px;">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="question-set-type">作业</div>
                            <div class="question-set-title">${testPaper.name }</div>
                            <div class="homwork-status">
                                <c:if test="${try_again }">
                                    <a href="${pageContext.request.contextPath}/exam/do_again.action?id=${testPaper.id }&courseId=${courseView.id}&exam_type=1&class_id=${class_id}" class="pull-right" style="margin-left:10px;">再次尝试</a>
                                </c:if>
                                <c:if test="${tab!=5 }">
                                    <div class="pull-right label label-success" style="margin-left:10px;">
                                ...
                                <c:if test="${tab==5 }">
                                    ...
                                    <c:if test="${exam.grade==2 }">
                                        <div class="pull-right label label-warning" style="margin-left:10px;">
                                            合格
                                        </div>
                                    </c:if>
                                    <c:if test="${exam.grade==3 }">
                                        <div class="pull-right label label-danger" style="margin-left:10px;">
                                            不合格
                                        </div>
                                    </c:if>
                                </c:if>
            ...
            <div class="row question-set-body">
                <div class="col-md-9 question-set-main" style="min-height: 400px;">
                                        ...
                                        <div class="testpaper-question-footer clearfix">
                                            <div class="testpaper-question-essay-inputs">
                                                <c:if test="${tab==1||tab==2 }">
                                                    ...
                                                    <div class="help-block" style="color:#70d445;">请输入答案</div>
                ...
                <div class="col-md-3 question-set-side">
                    <div class="question-set-card affix-top" data-spy="affix" data-offset-top="200" data-offset-bottom="200">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <c:forEach items="${testPaperQuestionViews}" var="question" varStatus="status">
                                    <a href="javascript:;" class="question-index" data-anchor="#question${question.question_id }">${status.count }</a>
                                </c:forEach>
