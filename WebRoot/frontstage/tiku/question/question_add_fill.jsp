                ...
                <div class="panel panel-default panel-col">
                    ...
                    <div class="panel-body">
                        ...
                        <div id="question-creator-widget">
                            <form id="question-create-form" class="form-horizontal quiz-question" method="post" action="${pageContext.request.contextPath}/question/question_add.action?type=1&courseId=${courseView.id}" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 controls">
                                        <c:set var="right_key" value=""/>
                                        <%-- 
                                        <textarea class="form-control" style="height: 180px;" id="question-stem-field" name="stem">
                                            <c:set var="right_keys" value="${fn:split(question.right_key, ',')}"/>
                                            <c:forEach items="${fn:split(question.stem, '______')}" var="stem" varStatus="status" >
                                                <c:if test="${!status.last}">

                                                    <c:set var="right_key" value="${right_key}${stem}[[${right_keys[status.index]}]]"/>
                                                </c:if>
                                                <c:if test="${status.last}">

                                                    <c:set var="right_key" value="${right_key}${stem}"/>
                                                </c:if>
                                            </c:forEach>
                                        ...
                                        <%-- 
                                        <input type="hidden" name="stem" value=""/>
                                        --%>
                                        ...
                                        <div class="help-block">
                                             输入<span style="color:red">[[ ]]</span>  可以插入填空项；，例如“今年是[[2014|马]]年”，回答“2014”或者“马”都算答对
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div id="advanced-collapse" class="advanced-collapse collapse">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 controls">
                                             ...
                                             <div  id="question-analysis-field">
                                             	${question.analysis }
                                             </div>
                                             <%-- 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4 controls">
                                            <input class="form-control"
                                                   ...
                                                   <c:if test="${empty question}">value="2"</c:if> type="text" id="" name="score" >
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
...
<script type="text/javascript">
    ...
    function verification(form){
        ...
        if($("textarea[ name = 'stem' ]").val()==="<p><br></p>"){
            alert("请输入题干");
            return false;
        }else if(!reg.test($("textarea[ name = 'stem' ]").val())){
            alert("请输入正确答案");
            return false;
        }else{
            return true;
