            ...
            <div class="col-md-9">
                ...
                <div class="panel-body">
                    ...
                    <div id="question-creator-widget">
                        <form id="question-create-form" class="form-horizontal quiz-question" method="post" action="${pageContext.request.contextPath}/question/question_add.action?type=4&courseId=${courseView.id}">
                            ...
                            <div class="form-group">
                                <div class="col-md-2 control-label"><label for="question-stem-field">材料</label></div>
                                <div class="col-md-8 controls">
                                    <%-- 
                                    <textarea class="form-control" id="question-stem-field"  name="stem" style="height: 180px;"><c:if test="${!empty question}">${question.stem }</c:if></textarea>
                                	--%>
                            ...
                            <div id="advanced-collapse" class="advanced-collapse collapse">
                                <div class="form-group">
                                    <div class="col-md-2 control-label"><label>解析</label></div>
                                    <div class="col-md-8 controls">
                                ...
                                <div class="form-group">
                                    <div class="col-md-2 control-label"><label>分值</label></div>
                            ...
                            <div class="form-group">
                                <div class="col-md-8 col-md-offset-2 controls">
                                    <button type="button" class="btn btn-primary submit-btn" id="redirect_btn">保存并添加子题</button>
