...
public interface TopicQuestionMapper {
    ...
    List<TopicQuestionMobileView>   selectByCourseIdM(@Param("source_id")long source_id,@Param("source_type")int source_type,@Param("user_id")Long user_id,@Param("type")Integer type);

    TopicQuestionMobileView selectByIdM(@Param("id")long id);
}