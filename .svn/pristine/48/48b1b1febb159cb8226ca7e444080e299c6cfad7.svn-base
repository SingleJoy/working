                    ...
                    <div class="panel-body">
                        <form id="messageForm" action="${pageContext.request.contextPath}/message/save_message.action" class="form-horizontal" method="post" novalidate="novalidate">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 controls">
                                    <div class="col-md-8 controls editDemo" id="content"  style="width:640px;" contentEditable="true" <c:if test="${message.status==1}">disabled="disabled"</c:if> >${message.content}</div>
                                    <%-- 
...
<script type="text/javascript">
    ...
    function doSumbit(value){
        ...
        if($("#title").val()!=""&&content_val.trim()!=="<p><br></p>"){
