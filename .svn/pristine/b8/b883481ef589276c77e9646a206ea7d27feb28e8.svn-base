...
<div class="cn-wrap" >
    ...
    <div class="container">
        ...
        <ol class="breadcrumb breadcrumb-o">
            ...
            <li><a href="${pageContext.request.contextPath}/community/to_community_index.action?sourceType=0&stamp=5&id=${workshopView.community_id}">${workshopView.community_name}</a></li>
                    ...
                    <div style="font-size: 16px;color: #fff;margin-top: 20px;">
                         <span title="工作坊人数">
                            <i class="es-icon es-icon-people" style="font-size: 20px;"></i>&nbsp;&nbsp;
                             <span class="text-danger">${workshopView.user_count}</span>
                        </span>
