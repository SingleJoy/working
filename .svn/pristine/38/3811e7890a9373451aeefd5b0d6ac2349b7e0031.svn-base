                ...
                <div class="panel  panel-col ">
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" id="saveFile" action="${pageContext.request.contextPath}/my_file_base/save_file.action" method="post">
                            <input type="hidden" name="name" id="name" value="${file_base.filename}.${file_base.format}">
                            ...
                            <div id="fielPages">
                                ...
                                <div class="form-group file_name"  id="section1">
                                    ...
                                    <div class="col-md-8 controls" style="margin-top: 9px">
                                    <input class="form-control" type="text" id="title_0" name="title" value="${file_base.filename }"></div>
                                </div>
                                ...
                                <div class="form-group" id="section3">
                                    ...
                                    <div class="col-md-8 controls">
                                    <select id="stage0" onchange="_stage(0,this.value)" class="form-control width-input width-input-large">
                                            <c:forEach items="${subject0List }" var="subject0">

                                                <option value="${subject0.id }"  <c:if test="${stage==subject0.id}">selected="selected"</c:if>>${subject0.subjectName }</option>
                                            </c:forEach>
                                ...
                                <div class="form-group" id="section4">
                                    ...
                                    <div class="col-md-8 controls" <c:if test="${empty textBook.subjectList}">style="display:none"</c:if>>
                                ...
                                <div class="form-group" id="section5">
                                    ...
                                    <div class="col-md-8 controls" <c:if test="${empty textBook.editionList}">style="display:none"</c:if>>
                                        <select  id="edition0" onchange="_edition(0)" class="form-control">
                                            <c:forEach items="${textBook.editionList }" var="edition0">

                                                <option value="${edition0.id }"  <c:if test="${pubver==edition0.id}">selected="selected"</c:if>>${edition0.versionName }</option>
                                            </c:forEach>
                                        </select><i class="changeTest" id="file_edition0"></i><br/>
                                    </div>
                                    <div <c:if test="${empty textBook.gradeList}">style="display:none"</c:if>>
                                    <br/>
                                    <br/>
                                    <br/>
                                    ...
                                    <div class="col-md-2 controls col-md-offset-1" <c:if test="${empty textBook.chapterList}">style="display:none"</c:if>>
                                    ...
                                    <div class="col-md-2 controls col-md-offset-1" <c:if test="${empty textBook.sectionList}">style="display:none"</c:if>>
                                ...
                                <div class="form-group" style="margin-top: 80px">
                                    <div class="col-md-offset-2  controls ">
                                        ...
                                        <button class="btn btn-fat btn-warning col-md-offset-1" id="btn_publish" type="submit">发布</button>
                                    </div>
                                </div>
                            </div>
                        </form>
     ...
     function _stage(index,type){
        ...
        $.ajax({
            ...
            success : function(json) {
                ...
                if(sub.length>0){
                    ...
                    $("#subject"+index).append('<option value='+sub[i].id+' >'+sub[i].subjectName+'</option>');
                     ...
                     $("#chapter"+index).parent().css("display","none");
                      $("#section"+index).parent().css("display","none");
                ...
                if(flag==1){
                if(sec.length>0){
                     $("#section"+index).parent().css("display","inline");
