...
<div class="cn-wrap">
    ...
    <div id="content-container" class="container">
        ...
        <div class="row row-3-9">
            ...
            <div class="col-md-9">
                <form id="trainForm" action="${pageContext.request.contextPath}/train/to_train.action" method="post">
                                    ...
                                    <td >
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-right" id="ul_${train.id}" style="display:none;">
                                                ...
                                                <li><a href="${pageContext.request.contextPath}/class/to_class.action?id=${train.id}&flag=2&sign=10&source_id=${train.id}&source_type=1&jumpType=-1" target="_blank">班级管理</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
