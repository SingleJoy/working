                        ...
                        <div class="col-lg-3 col-md-4 col-xs-6">
                            <div class="course-item">
                                <div class="course-img">
                                    <a href="javascript:void(0);" target="_blank" onclick="toDetail(${course.id},1);">
                    ...
                    <c:if test="${!empty trainList  }">
                        ...
                        <c:forEach items="${trainList}" var="train">
                            <div class="col-lg-3 col-md-4 col-xs-6">
                                <div class="course-item">
                                    <div class="course-img">
                                        <a href="javascript:void(0);" target="_blank" onclick="toDetail(${train.id},2);">
                                ...
                                <div class="course-item">
                                    <div class="course-img">
                                        <a href="${pageContext.request.contextPath}/lesson_main/to_lesson.action?id=${l.id }" target="_blank" >
                                            ...
                                            <c:if test="${!empty l.lesson_pic}">
                                                <span class="content_tags" style="margin-top: -120px;">
                                                        ${l.grade }${l.subject }
                                                </span>
                                            </c:if>
                                        </a>
                                ...
                                <div class="course-img">
                                    <a href="${pageContext.request.contextPath}/community/to_community_index.action?sourceType=1&stamp=5&id=${workshopView.id}" target="_blank">
                                        ...
                                        <c:if test="${!empty workshopView.periodName}">
                                            <span class="content_tags" style="margin-top: -45px;">
                                                    ${workshopView.periodName }${workshopView.subjectName }
                                            </span>
                                        </c:if>
                                    </a>
                                </div>
                        ...
                        <div class="teacher-item" >
                            <div class="teacher-top">
                                <a class="teacher-img" href="${pageContext.request.contextPath}/teacher_center/to_teacher_center.action?user_id=${student.user_id}">
                                    <img class="avatar-lg" src="${pageContext.request.contextPath}${student.icon}" style="height: 120px;width: 120px;">
                                </a>
                                <h3 class="title">
