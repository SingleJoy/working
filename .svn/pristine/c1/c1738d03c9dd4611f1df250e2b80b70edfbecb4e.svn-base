...
public class StudentRelationController {
	...
	public ModelAndView toStudentRelationManager(HttpServletRequest request,StudentRelationView student){
		...
		try {
			...
			modelAndView.addObject("head_title", "用户管理");
	...
	@ResponseBody
	public JSONObject verifyStudent(HttpServletRequest request,StudentRelationView student) {
