...
<style>
   ...
   .testpaper-question-choice {margin-bottom: 30px;}
</style>
<body style="background-color: #fff;">
<div class="cn-wrap">

    <div id="content-container" class="container" >
        <div class="cn-section testpaper-heading" style="padding: 10px;">
            <div class="testpaper-titlebar clearfix" style="padding-bottom: 20px;">
                <h3 class="testpaper-title" style="font-size:16px;margin-top: 0;">${testPaper.name }
                    <br>
                    <br>
                    <small class="text-sm" >交卷时间：
                ...
                <div class="pull-left" >
                    <c:if test="${tab==3||tab==4 }">?</c:if>

                    <small>分</small>
                    <small class="text-muted">总分
                        ${total_score0+total_score1+total_score2+total_score3+total_score5 } 分
                    </small>
                </div>
            </div>
            ...
            <c:if test="${tab==5 }">
                    <c:if test="${try_again }">
                        <c:if test="${exam.grade!=3 }">
                            <div class="alert alert-success">恭喜您成功通过考试!
                                <span class="mlm"></span>您本次考试获得
                                <span class="text-danger"><c:if test="${tab==5 }">${exam.exam_score}</c:if></span>分
                            </div>
                        </c:if>
                        <c:if test="${exam.grade==3 }">
                            <div class="alert alert-danger">
                                您未通过考试，请<a href="${pageContext.request.contextPath}/course/to_study_again_m.action?id=${course_hour_id }&class_id=${class_id }&user_id=${user_id }" class="text-success">重新参加考试</a>，或者重新学习课程。
                            </div>
                        </c:if>
                    </c:if>
                    <c:if test="${!try_again }">
            ...
            <div style="overflow: auto;">
                <div id="testpaper-navbar" class="testpaper-navbar affix-top pull-left" data-spy="affix" >
                ...
                <div class="testpaper-body">
                    <form id="teacherCheckForm" autocomplete="off" novalidate="novalidate" >
                        ...
                        <c:if test="${testPaperQuestionViews0.size()>0&&tab!=4 }">
                            <div class="panel panel-default testpaper-question-block" id="testpaper-questions-choice2" style="margin-top: 50px;">
                                    ...
                                    <c:forEach items="${testPaperQuestionViews0 }" var="question">
                                        ...
                                        <div class="testpaper-question testpaper-question-choice " id="question${question.question_id }" data-question-id="${question.id }" data-right="${question.is_right }" >
                                            <div class="testpaper-question-body">
                                                ...
                                                <ul class="testpaper-question-choices no-border" >
                                                    <li class=""><span class="testpaper-question-choice-index <c:if test="${tab==3||tab==4||tab==5 }"><c:if test="${fn:contains(question.right_key, 'A')}">question-text-success</c:if></c:if>">A.</span>
                                                        <div class="choice-body <c:if test="${tab==3||tab==4||tab==5 }"><c:if test="${fn:contains(question.right_key, 'A')}">question-text-success</c:if></c:if>">
                                                            <p>${question.option_a }</p>
                                                        </div>
