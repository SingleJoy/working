...
<section  style="height:400px;width: 100%;position: relative;z-index:1;">
            ...
            <div class="text-center" >
                <div class="form-group " style="margin-top: 180px;">
                    <div style="width: 40%;margin-left: 30%;">
                        <input class="form-control input-lg workshop_home_search" type="text"  placeholder="搜索你喜欢的" style="color:#fff;">
                    </div>
...
<div style="background-color:#fff; ">
            ...
            <div class="row">
                ...
                <c:forEach items="${workshops1 }" var="w">
                    ...
                    <div class="col-lg-3 col-md-3 col-xs-3 workshop_list">
                        ...
                        <div class="workshop_attend_item">

                            <div class="workshop_attend_item_list" >
                                <a href="${pageContext.request.contextPath}/community/to_community_index.action?sourceType=1&stamp=5&id=${w.id}" target="_blank" >

                                    <img src="${pageContext.request.contextPath}${w.img}"  class="avatar-lg-md" >
                                        <%--背景--%>
                                        <%--<img src="${pageContext.request.contextPath}/${h.back_img }" alt="" class="img-responsive" >--%>
                                    <span class="text-center workshop_name_attend" title="${w.name}">
                                        ${fn:substring(w.name,0,10)}
    ...
    <section class="workshop_recommend">
        ...
        <div class="container">
                    ...
                    <c:if test="${(h.count%2!=0 &&(h.count-1)%8==0)||(h.count%2==0 &&(h.count-6)%8==0) }">
                        ...
                        <div class="workshop_recommend_list">
                            ...
                            <a href="${pageContext.request.contextPath}/community/to_community_index.action?sourceType=1&stamp=5&id=${workshops[i].id}" target="_blank" style="position: relative;">
                                <img  src="${pageContext.request.contextPath}${workshops[i].img }" class=" workshop_pic" >
                    ...
                    <c:if test="${(h.count%2==0 &&(h.count-2)%8==0)||(h.count%2!=0 &&(h.count-7)%8==0) }">
                        ...
                        <div class="workshop_recommend_list" >
                            ...
                            <div class="workshop_list_page" style="margin-top: 5px;">
                                ...
                                <a href="${pageContext.request.contextPath}/workshop/to_workshop_home_2nd.action?stage_id=${workshops[i].period}&subject_id=${workshops[i].subject}" target="_blank" class="subject text-muted workshop_home_list_sec" >
                                    <span class="pull-right">${workshops[i].subjectName }</span>
                                </a>
                                <a href="${pageContext.request.contextPath}/community/to_community_index.action?sourceType=1&stamp=5&id=${workshops[i].id}" target="_blank" class="text-muted workshop_list_name workshop_list_name_sec" >
                    ...
                    <c:if test="${(h.count%2==0 &&(h.count-4)%8==0)||(h.count%2!=0 &&(h.count-5)%8==0) }">
                        ...
                        <div  class="workshop_recommend_list">
                            ...
                            <div  class="workshop_recommend_list_content">
                                ...
                                <a href="${pageContext.request.contextPath}/community/to_community_index.action?sourceType=1&stamp=5&id=${workshops[i].id}" class="recommend_list_name" title="${workshops[i].name }">${fn:substring(workshops[i].name,0,12)}</a>
            ...
            <div class="section-more-btn" style="clear: both;padding: 50px 0;">
                <a href="${pageContext.request.contextPath}/workshop/to_workshop_home_2nd.action" class="btn btn-default btn-lg" style="font-size: 18px;">
